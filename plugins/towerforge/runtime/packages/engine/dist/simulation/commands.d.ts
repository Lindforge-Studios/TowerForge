...
export { GAME_COMMAND_SCHEMA_VERSION, GAME_COMMAND_SUPPORTED_SCHEMA_VERSIONS, type GameCommand, type GameCommandV1, type GameCommandV2 } from "./command-internal.js";
