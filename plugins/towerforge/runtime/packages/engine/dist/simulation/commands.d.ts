...
export { GAME_COMMAND_SCHEMA_VERSION, GAME_COMMAND_SUPPORTED_SCHEMA_VERSIONS, type GameCommand, type GameCommandV1, type GameCommandV2, type GameCommandV3, type GameCommandV4, type GameCommandV5 } from "./command-internal.js";
