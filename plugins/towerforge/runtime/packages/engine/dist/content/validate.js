...
import { HeroesProfileValidationError, normalizeHeroesProfileV1, normalizeHeroesProfileV2 } from "./heroes-mechanics.js";
...
export function validateGameContentRegistry(content) {
    ...
    const validateHeroesMechanics = () => {
        ...
        if (module.schemaVersion !== 1 && module.schemaVersion !== 2) {
            err("mechanics", "heroes", "modules.heroes.schemaVersion", "Heroes future or unsupported schemaVersion; only versions 1 and 2 are supported.");
        }
        if (typeof module.enabled !== "boolean") {
