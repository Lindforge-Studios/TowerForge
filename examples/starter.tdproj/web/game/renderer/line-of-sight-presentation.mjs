...
function record(value, requiredKeys, optionalKeys = []) {
  ...
  try {
    ...
    symbols = value && typeof value === "object" ? Object.getOwnPropertySymbols(value) : [];
    array = Array.isArray(value);
  } catch {
    return undefined;
  }
  if (!descriptors || array || prototype !== Object.prototype || symbols.length) return undefined;
...
function denseArray(value) {
  ...
  const extra = Object.keys(descriptors).some((key) => key !== "length"
