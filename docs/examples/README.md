...
| Opt-in hero roster, movement, and durability | `docs/examples/opt-in-hero-roster/` | `mechanics.json` is static Heroes v1; `mechanics-mobile.json` independently adds v2 movement; `mechanics-durable.json` adds v3 HP/shield without enabling navigation or later hero mechanics. |
