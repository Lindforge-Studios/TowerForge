...
export type BallisticsCheckpointState =
  | BallisticsCheckpointStateV1
  | BallisticsCheckpointStateV2
  | BallisticsCheckpointStateV3
  | BallisticsCheckpointStateV4;
