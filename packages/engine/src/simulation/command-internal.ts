...
export const GAME_COMMAND_SCHEMA_VERSION = 4 as const;
export const GAME_COMMAND_SUPPORTED_SCHEMA_VERSIONS = Object.freeze([1, 2, 3, 4] as const);
...
export type GameCommandV2 =
  ...
  | { readonly schemaVersion: 2; readonly type: "upgradeTower"; readonly towerId: string }
  | {
      readonly schemaVersion: 2;
      readonly type: "setTargetMode";
      readonly towerId: string;
...
function isCommandId(schemaVersion: 1 | 2 | 3 | 4, value: unknown): value is string {
...
export function parseGameCommand(input: unknown): GameCommand | undefined {
  ...
  if ((schemaVersion !== 1 && schemaVersion !== 2 && schemaVersion !== 3 && schemaVersion !== 4) || typeof type !== "string") return undefined;
